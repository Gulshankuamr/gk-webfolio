...
// ❌ public images ko import nahi karte
// ✅ direct path use hota hai
...
const techStack: TechItem[] = [
  ...
  { name: 'JavaScript', icon: '/assets/javascript.webp' },
  { name: 'TypeScript', icon: '/assets/typescript.svg' },
  { name: 'ReactJS', icon: '/assets/react.png' },
  { name: 'NextJS', icon: '/assets/nextjs.png' },
  { name: 'Tailwind CSS', icon: '/assets/tailwindcss.png' },
  { name: 'Framer Motion', icon: '/assets/framermotion.png' },
  { name: 'Shadcn', icon: '/assets/shadcn.png' },
  { name: 'NodeJS', icon: '/assets/nodejs.png' },
  { name: 'ExpressJS', icon: '/assets/expressjs.png' },
  ...
  { name: 'npm', icon: '/assets/npm.webp' },
  { name: 'Figma', icon: '/assets/figma.png' },
  { name: 'REST API', icon: '/assets/restapi.webp' },
];
...
const TechStack: React.FC = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen w-full pt-24 sm:pt-52 bg-black text-white py-12 sm:py-20 relative"
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center mb-10 sm:mb-16">
